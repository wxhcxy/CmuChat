...
TextChatMsgRsp ChatGrpcClient::NotifyTextChatMsg(std::string server_ip,
	...
	Defer defer([&rsp, &req]() {
		...
		for (const auto& text_data : req.textmsgs()) {
			std::cout << "ChatGrpcClient::NotifyTextChatMsg  text_data.msgid():  " << text_data.msgid() << std::endl;
			std::cout << "ChatGrpcClient::NotifyTextChatMsg  text_data.msgcontent():  " << text_data.msgcontent() << std::endl;
